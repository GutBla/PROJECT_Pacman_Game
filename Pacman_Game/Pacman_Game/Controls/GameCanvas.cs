...
namespace Pacman_Game.Controls
{
    public class GameCanvas : Control
    {
        ...
        private void LoadGhostSprites(GhostColor color, string ghostName)
        {
            ...
            var normalSprites = new Bitmap[2];
            normalSprites[0] = LoadBitmap($"avares://Pacman_Game/Assets/sprites/ghost/{ghostName}/{ghostName}_down_1.png");
            normalSprites[1] = LoadBitmap($"avares://Pacman_Game/Assets/sprites/ghost/{ghostName}/{ghostName}_down_2.png");
            states[GhostState.Chase] = normalSprites;
            states[GhostState.Scatter] = normalSprites;


            var frightenedSprites = new Bitmap[2];
            frightenedSprites[0] = LoadBitmap("avares://Pacman_Game/Assets/sprites/ghost/ghost_scared/ghost_scared_1.png");
            frightenedSprites[1] = LoadBitmap("avares://Pacman_Game/Assets/sprites/ghost/ghost_scared/ghost_scared_2.png");
            states[GhostState.Frightened] = frightenedSprites;


            var eyesSprites = new Bitmap[4];
            eyesSprites[0] = LoadBitmap("avares://Pacman_Game/Assets/sprites/ghost/ghost_eyes/eyes_right.png");
            eyesSprites[1] = LoadBitmap("avares://Pacman_Game/Assets/sprites/ghost/ghost_eyes/eyes_left.png");
            eyesSprites[2] = LoadBitmap("avares://Pacman_Game/Assets/sprites/ghost/ghost_eyes/eyes_up.png");
            eyesSprites[3] = LoadBitmap("avares://Pacman_Game/Assets/sprites/ghost/ghost_eyes/eyes_down.png");
            states[GhostState.Eaten] = eyesSprites;
        ...
        private void DrawPacman(DrawingContext context, int cellSize)
        {
            ...
            if (_pacmanSprites.TryGetValue(pacman.CurrentDirection, out var frames)
                && frames != null
                && _currentFrame < frames.Length)
            {
                context.DrawImage(frames[_currentFrame], rect);
            }
        }
        ...
        private void DrawGhosts(DrawingContext context, int cellSize)
        {
            ...
            foreach (var ghost in _viewModel.Ghosts)
            {
                    ...
                    && frames.Length > 0)
                {
                    ...
                    {
                        frame = _currentFrame < frames.Length ? frames[_currentFrame] : frames[0];
                    }
